...
# =========================
def fetch_existing_user_tables_with_schema(cursor, created_by):
    cursor.execute("""
    ...
    try:
       ...
       #  AUTH FROM JWT ONLY
        ...
        if action == "upload":
            ...
            existing = fetch_existing_user_tables_with_schema(cur, created_by)
        ...
        if action == "insert_data":
                ...
                file_hash = make_file_hash(created_by, file_name)
